...
(185, 1, 5, 'hasDate', 'a pour date', NULL),
(186, 1, 5, 'hasLocation', 'a pour lieu', NULL),
(187, 1, 5, 'involvesPerson', 'implique la personne', NULL),
(188, 1, 5, 'relatedDocument', 'document lié', NULL),
(189, 1, 5, 'hasTranscript', 'a comme transcription', NULL),
(190, 1, 5, 'hasResponse', 'a comme réponse', NULL),
(191, 1, 5, 'hasAudioResponse', 'a comme réponse audio', NULL),
(192, 1, 5, 'displayOnTimeline', 'affiché sur la frise chronologique', NULL),
(193, 1, 5, 'generatedAt', 'généré à', NULL),
(194, 1, 5, 'confidenceScore', 'score de confiance', NULL),
(195, 1, 5, 'summaryText', 'texte du résumé', NULL),
(196, 1, 5, 'audioFile', 'fichier audio', NULL),
(197, 1, 5, 'imageURL', 'image illustrant l\'événement', NULL),
(198, 1, 5, 'geoCoordinates', 'coordonnées géographiques', NULL),
(199, 1, 5, 'placeName', 'nom du lieu', NULL);
...
(106, 1, 5, 'HistoricalEvent', 'Événement historique', 'Un événement historique survenu à un lieu et une date donnée.'),
(107, 1, 5, 'Location', 'Lieu', 'Un lieu géographique associé à un événement historique.'),
(108, 1, 5, 'Person', 'Personne historique', 'Individu impliqué dans un événement historique.'),
(109, 1, 5, 'Document', 'Document d’archive', 'Une source primaire ou secondaire (texte, image, son, vidéo) liée à un événement.'),
(110, 1, 5, 'UserQuery', 'Question utilisateur', 'Une requête orale ou textuelle posée par l’utilisateur à TimeWhisper.'),
(111, 1, 5, 'Response', 'Réponse générée', 'Réponse contextuelle (texte, audio, visuel) produite par TimeWhisper.'),
(112, 1, 5, 'Timeline', 'Frise chronologique', 'Représentation interactive des événements historiques liés à une requête.'),
(113, 1, 5, 'Transcript', 'Transcription vocale', 'Texte transcrit à partir d’une requête vocale de l’utilisateur.'),
(114, 1, 5, 'AudioResponse', 'Réponse audio', 'Version audio de la réponse générée.');
...
(3, 1, 106, NULL, NULL, 'Événement historique'),
(4, 1, 107, NULL, NULL, 'Lieu'),
(6, 1, 109, NULL, NULL, 'Document d’archive'),
(7, 1, 110, NULL, NULL, 'Question utilisateur'),
(8, 1, 111, NULL, NULL, 'Réponse générée'),
(9, 1, 114, NULL, NULL, 'Réponse audio'),
(10, 1, 112, NULL, NULL, 'Frise chronologique'),
(11, 1, 113, NULL, NULL, 'Transcription');
...
(41, 3, 185, NULL, NULL, 1, NULL, 0, 0, NULL),
(42, 3, 186, NULL, NULL, 2, NULL, 0, 0, NULL),
(43, 3, 187, NULL, NULL, 3, NULL, 0, 0, NULL),
(44, 3, 188, NULL, NULL, 4, NULL, 0, 0, NULL),
(45, 3, 197, NULL, NULL, 5, NULL, 0, 0, NULL),
(46, 3, 192, NULL, NULL, 6, NULL, 0, 0, NULL),
(47, 4, 199, NULL, NULL, 1, NULL, 0, 0, NULL),
(48, 4, 198, NULL, NULL, 2, NULL, 0, 0, NULL),
(49, 7, 189, NULL, NULL, 1, NULL, 0, 0, NULL),
(50, 7, 190, NULL, NULL, 2, NULL, 0, 0, NULL),
(51, 7, 191, NULL, NULL, 3, NULL, 0, 0, NULL),
(52, 8, 195, NULL, NULL, 1, NULL, 0, 0, NULL),
(53, 8, 193, NULL, NULL, 2, NULL, 0, 0, NULL),
(54, 8, 194, NULL, NULL, 3, NULL, 0, 0, NULL),
(55, 8, 192, NULL, NULL, 4, NULL, 0, 0, NULL),
(56, 9, 196, NULL, NULL, 1, NULL, 0, 0, NULL);
...
(5, 1, 'https://raw.githubusercontent.com/Zackbellaj/TimeWhisper/main/assets/vocab#', 'tw:', 'TimeWhisper', '');
